package com.bpao.learnSpringSecurity.service;
...
public class UserDetailsService implements ReactiveUserDetailsService {
    ...
    public Mono<UserDetails> findByUsername(String username) {
        ...
        return userRepository.findByUsername(username)
                ...
                .map(userEntity -> {
                    log.info("Password en BD: {}", userEntity.getPassword());
                    boolean coincide = passwordEncoder.matches("12345", userEntity.getPassword());
